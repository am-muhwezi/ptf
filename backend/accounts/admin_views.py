...
class AdminManagementViewSet(viewsets.ModelViewSet):
    ...
    queryset = User.objects.filter(Q(is_staff=True) | Q(is_superuser=True)).order_by(
        "-date_joined"
    )
    ...
    def list(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {"error": "Failed to retrieve admin users", "message": str(e)},
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {"error": "Failed to create admin user", "message": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    def update_permissions(self, request, pk=None):
        ...
        try:
            ...
            return Response(
                {"error": "Failed to update permissions", "message": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    def reset_password(self, request, pk=None):
        ...
        try:
            ...
            return Response(
                {"error": "Failed to reset password", "message": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {"error": "Failed to delete admin user", "message": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
